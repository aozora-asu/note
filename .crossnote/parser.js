  ...
  onWillParseMarkdown: async function (markdown) {
    markdown = markdown.replace(
      ...
      (danger_alert, title, content) => {
        return `<div style="border-left: 4px solid #ff8c00; background-color: #fff5e6; padding: 16px; border-radius: 6px; margin: 16px 0;">
    ...
    markdown = markdown.replace(
      ...
      (success_alert, title, content) => {
        return `<div style="border-left: 4px solid #0366d6; background-color: #f1f8ff; padding: 16px; border-radius: 6px; margin: 16px 0;">
    ...
    markdown = markdown.replace(
      ...
      (info_alert, title, content) => {
        return `<div style="border-left: 4px solid #8957E5; background-color: #e7dbff; padding: 16px; border-radius: 6px; margin: 16px 0;">
    ...
    markdown = markdown.replace(
      ...
      (tip_alert, title, content) => {
        return `<div style="border-left: 4px solid #28a745; background-color: #e6ffed; padding: 16px; border-radius: 6px; margin: 16px 0;">
    ...
    markdown = markdown.replace(
      /:::caution(.*?)\n([\s\S]*?):::/gm,
      (tip_alert, title, content) => {
        return `<div style="border-left: 4px solid #d93f0b; background-color: #fff5f5; padding: 16px; border-radius: 6px; margin: 16px 0;">
