import{d as _,ak as u,z as h,o as n,b as l,e as t,x as s,B as r,F as f,ah as g,ac as v,l as x,g as b}from"../modules/vue-vWtuqWGm.js";import{a as k,u as y,z as m}from"../index-p4XIp42N.js";import{_ as N}from"./NoteDisplay.vue_vue_type_style_index_0_lang-ByiNqizR.js";import"../modules/shiki-DU3eGCQ8.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},z={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},C={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=k();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
